      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          {order.Material_description && (
            <p className="text-[10px] text-muted-foreground mt-0.5 truncate">{order.Material_description}</p>
          )}
        ...
        <div className="shrink-0">
          {isReceived ? (
            ...
            <button
              onClick={() => onReceive(shipment)}
              className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded bg-area-warehouse-bg text-area-warehouse hover:opacity-80 transition-opacity"
            >
